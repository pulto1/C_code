...
//	scanf("%d", &line);//6
//	//上->line
//	for (i = 1; i <= line; i++) //共打印line行
//	{
//		//打印一行
//		//打印空格，再打印*
//		int j = 0;
//		for (j = 0; j <line-i; j++) //打印每行的空格数
//		{
//			printf(" ");
//		}
//		for (j = 0; j < 2*i-1; j++) //打印每行的*数
//		{
//			printf("*");
//		}
//		printf("\n");  //打印完一行之后进行换行
//	}
////	//下->line-1
//	for (i = 1; i <= line - 1; i++) //下半部分共打印line-1行
//	{
//		//打印一行
//		//打印空格，再打印*
//		int j = 1;
//		for (j = 0; j < i; j++) //打印每行的空格数
//		{
//			printf(" ");
//		}
//		for (j = 0; j <(line-i)*2-1; j++)//打印每行的*数
//		{
//			printf("*");
//		}
//		printf("\n");
